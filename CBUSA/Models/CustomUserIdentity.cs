...
namespace CBUSA.Models
{
    public class CustomUserIdentity : ClaimsIdentity
    {
        ...
        public CustomUserIdentity(IEnumerable<Claim> claims, string authenticationType)
        ...
        public CustomUserIdentity(IEnumerable<string> roles, IEnumerable<string> groups, string IP, int id)
        {
